...
<table class="table table-bordered hovered table-hover">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($query_post_result)) {
            ...
            echo "<td><a href='./posts.php?source=post_update&p_id={$row['post_id']}'>Edit</a></td>";
            echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete this Post')\" href='./posts.php?source=post_delete&p_id={$row['post_id']}'>Delete</a></td>";
            echo "</tr>";
        }
        ?>
